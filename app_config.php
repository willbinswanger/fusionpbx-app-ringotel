<?php 
    ...
    $y++;
    $apps[$x]['default_settings'][$y]['default_setting_uuid'] = "1b029ba1-c05d-4233-9f3d-e261368aa3b9";
    $apps[$x]['default_settings'][$y]['default_setting_category'] = "ringotel";
    $apps[$x]['default_settings'][$y]['default_setting_subcategory'] = "ringotel_portal_username";
    $apps[$x]['default_settings'][$y]['default_setting_name'] = "text";
    $apps[$x]['default_settings'][$y]['default_setting_value'] = "";
    $apps[$x]['default_settings'][$y]['default_setting_enabled'] = "true";
    $apps[$x]['default_settings'][$y]['default_setting_description'] = "Admin portal login (shell.ringotel.co) used as Basic auth for user log downloads";
    $y++;
    $apps[$x]['default_settings'][$y]['default_setting_uuid'] = "a158581e-c415-490a-a0b3-8aea150af097";
    $apps[$x]['default_settings'][$y]['default_setting_category'] = "ringotel";
    $apps[$x]['default_settings'][$y]['default_setting_subcategory'] = "ringotel_portal_password";
    $apps[$x]['default_settings'][$y]['default_setting_name'] = "text";
    $apps[$x]['default_settings'][$y]['default_setting_value'] = "";
    $apps[$x]['default_settings'][$y]['default_setting_enabled'] = "true";
    $apps[$x]['default_settings'][$y]['default_setting_description'] = "Admin portal password (shell.ringotel.co) used as Basic auth for user log downloads";
    $y++;
